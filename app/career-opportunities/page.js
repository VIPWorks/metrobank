              ...
              <div className="inner-container">
                  ...
                  <div className="inner-box">
                    <div className="author-box">
                      <figure className="thumb-box">
                        <img src="assets/images/resource/career-1.jpg" alt="" />
                      </figure>
                ...
                <div className="career-block-one">
                  <div className="inner-box">
                    <div className="author-box">
                      <figure className="thumb-box">
                        <img src="assets/images/resource/career-2.jpg" alt="" />
                      </figure>
                      <div className="text-box">
                ...
                <div className="career-block-one">
                  <div className="inner-box">
                    <div className="author-box">
                      <figure className="thumb-box">
                        <img src="assets/images/resource/career-3.jpg" alt="" />
                      </figure>
                      <div className="text-box">
                ...
                <div className="career-block-one">
                  <div className="inner-box">
                    <div className="author-box">
                      <figure className="thumb-box">
                        <img src="assets/images/resource/career-4.jpg" alt="" />
                      </figure>
                      <div className="text-box">
                ...
                <div className="career-block-one">
                  <div className="inner-box">
                    <div className="author-box">
                      <figure className="thumb-box">
                        <img src="assets/images/resource/career-5.jpg" alt="" />
                      </figure>
                      <div className="text-box">
