...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={'Metro'} footerStyle={1} breadcrumbTitle="Broker Partnerships">
                <div>
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-8 col-md-12 col-sm-12 content-column">
                                ...
                                <div className="content-box mr_110">
                                    ...
                                    <h2 className="mb_20">Welcome to CWBANK's Broker Partnerships program</h2>
                                    <h6>Pioneering Collaborative Success</h6>
                    ...
                    <div className="auto-container">
                        <div className="content-box mt_60 mb_60 text-center">
                                <div className="mt_60">
                                    ...
                                    <p className="mb_30 lead_text">Join CWBANK's Broker Partnerships program and embark on a journey of collaborative success. Whether you're looking to expand your product offerings, enhance your technological capabilities, or increase your earning potential, CWBANK is here to support you every step of the way. Contact us today to learn more about how our Broker Partnerships program can help you achieve your business goals and thrive in the ever-evolving world of online trading.</p>
                                </div>
                        </div>
                    </div>
                </section>
