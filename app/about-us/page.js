                  ...
                  <div className="image-box pr_110 mr_20">
                    ...
                    <div className="rating-box">
                      ...
                      <ul className="thumb-list">
                        <li>
                          <img
                            src="assets/images/resource/thumb-1.png"
                            alt=""
                          />
                        </li>
                        <li>
                          <img
                            src="assets/images/resource/thumb-2.png"
                            alt=""
                          />
                        </li>
                        <li>
                          <img
                            src="assets/images/resource/thumb-3.png"
                            alt=""
                          />
                        </li>
                        <li>
                          <img
                            src="assets/images/resource/thumb-4.png"
                            alt=""
                          />
                        </li>
                      </ul>
                ...
                <div className="content_block_one">
                  <div className="content-box ml_40">
                    ...
                    <div className="text-box mb_40">
                      <p>
                        At CW BANK, we are dedicated to empowering individuals
                        and businesses to achieve their financial goals with
                        confidence and clarity. As a leading provider of
                        comprehensive financial services, we offer a wide range
                        of products and solutions tailored to meet the diverse
                    ...
                    <div className="inner-box mb_45">
                      <div className="single-item">
                        ...
                        <p>
                          Discover a world of possibilities with CW BANK.
                          Whether you're looking to manage your personal
                          finances, grow your wealth, or expand your business,
                          we have the expertise, resources, and technology to
                          help you succeed.
                        </p>
                      </div>
                      <div className="single-item">
                        ...
                        <p>
                          ...
                          offer personalized financial solutions designed to
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                  <div className="image-box">
                    <figure className="image image-1">
                      <img
                        src="assets/images/resource/CW-Bank-mobile-1.png"
                        alt=""
                      />
                    </figure>
                    <figure className="image image-2">
                      <img
                        src="assets/images/resource/CW-Bank-mobile-2.png"
                        alt=""
                      />
                    </figure>
                  </div>
...
>>>>>>> 302d0fe37c74a62521d8b28969adafc2b30e67c2
                    ...
                    <div className="text-box mb_50">
                      <p>
                        Manage your finances anytime, anywhere with CW Bank's
                        mobile app, empowering you with intuitive features for
                        efficient banking at your fingertips.
                      </p>
                    </div>
                    <div className="btn-box">
                      <Link href="/about" className="play-store mr_20">
